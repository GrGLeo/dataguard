...
fn test_range_float_with_nulls() {
    let rule = Range::new("range_test".to_string(), 0.0, Some(1.5), Some(10.5));
...
fn test_range_exact_boundaries() {
    let rule = Range::new("range_test".to_string(), 0.0, Some(5i64), Some(5i64));
...
fn test_monotonicity_single_element() {
    let rule = Monotonicity::<i64>::new("monotonicity_test".to_string(), 0.0, true);
...
fn test_monotonicity_with_floats() {
    let rule = Monotonicity::<f64>::new("monotonicity_test".to_string(), 0.0, true);
...
fn test_monotonicity_float_descending() {
    let rule = Monotonicity::<f64>::new("monotonicity_test".to_string(), 0.0, false);
...
fn test_range_all_valid_integers() {
    let rule = Range::new("range_test".to_string(), 0.0, Some(0i64), Some(100i64));
...
fn test_range_all_invalid_integers() {
    let rule = Range::new("range_test".to_string(), 0.0, Some(10i64), Some(20i64));
...
fn test_range_negative_floats() {
    let rule = Range::new("range_test".to_string(), 0.0, Some(-10.0), Some(-1.0));
